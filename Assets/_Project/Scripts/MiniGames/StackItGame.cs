...
{
    public sealed class StackItGame : MonoBehaviour, IMiniGame
    {
        private const string StableGameId = "stack-it";
        ...
        public void PlaceBlock(bool successful, int points = 1)
        {
            if (!IsRunning || !successful || points <= 0) return;
